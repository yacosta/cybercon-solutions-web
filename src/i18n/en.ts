export const en = {
  ...
  form: {
    ...
    graphicLabel: 'Interactive network map. Move your pointer; nodes light up as you complete the form.',
    graphicCaption: 'Your stack, mapped',
    graphicHint: 'Drag across the mesh — each field you fill strengthens the link.',
    nodeName: 'Identity',
    nodeCompany: 'Business',
    nodeEmail: 'Channel',
    nodeCore: 'Cybercon',
    progressIdle: 'Awaiting details',
    progressPartial: 'Building your map',
    progressReady: 'Ready to assess',
    progressDone: 'Request secured',
  },
  services: {
